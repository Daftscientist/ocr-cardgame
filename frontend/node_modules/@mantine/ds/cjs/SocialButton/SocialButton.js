...
function SocialButton(_a) {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Button, __spreadValues({
    component: "a",
    target: "_blank",
...
function DiscordButton(_c) {
  ...
  return /* @__PURE__ */ React__default.createElement(SocialButton, __spreadValues({
    sx: [
      (theme) => __spreadValues({
        backgroundColor: meta.meta.discordColor
      }, theme.fn.hover({ backgroundColor: theme.fn.lighten(meta.meta.discordColor, 0.1) })),
      ...utils.packSx(sx)
    ],
    icon: /* @__PURE__ */ React__default.createElement(DiscordIcon.DiscordIcon, {
      size: 16
    }),
...
function TwitterButton(_e) {
  ...
  return /* @__PURE__ */ React__default.createElement(SocialButton, __spreadValues({
    sx: [
      (theme) => __spreadValues({
        backgroundColor: meta.meta.twitterColor
      }, theme.fn.hover({ backgroundColor: theme.fn.lighten(meta.meta.twitterColor, 0.1) })),
      ...utils.packSx(sx)
    ],
    icon: /* @__PURE__ */ React__default.createElement(TwitterIcon.TwitterIcon, {
      size: 16
    }),
